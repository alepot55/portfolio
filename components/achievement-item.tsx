...
export function AchievementItem({ achievement, index = 0 }: AchievementItemProps) {
  ...
  return (
    <motion.div
      ...
      className="flex gap-4 p-5 rounded-xl border border-gray-200 dark:border-gray-800"
    >
      <div className="shrink-0 mt-0.5">
        <div className="w-10 h-10 flex items-center justify-center rounded-full bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400">
      ...
      <div className="min-w-0">
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-1 mb-1">
          ...
          <span className="text-xs text-gray-400 dark:text-gray-500 shrink-0">{achievement.date}</span>
        </div>
